<%-- 
    ...
    Created on : 07/06/2021, 03:50:57 PM
    Author     : Alvaro
--%>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <span class="help-block">Nombre de proveedor</span>  
                    </div>
                </div>

                <!-- Text input-->
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Procedencia</label>  
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Número de docuemnto</label>  
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <span class="help-block">Nro de teléfono</span>  
                    </div>
                </div>
                ...
                <!--
                <div class="form-group">
                    <label class="col-md-4 control-label" for="button1id">Listar usuarios</label>
                    <div class="col-md-8">
                        <button id="button1id" name="button1id" class="btn btn-success">Activos</button>
                        <button id="button2id" name="button2id" class="btn btn-danger">Inactivos</button>
                    </div>
                </div>
                -->
            </fieldset>
