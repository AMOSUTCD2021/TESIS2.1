<%-- 
    Document   : servicio
    Created on : 17/06/2021, 04:43:45 PM
    Author     : Alvaro
--%>
        ...
        <div>
            <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                <ul class="nav navbar-nav">
                    <form action="registarservicio.jsp" method="POST">
                        <li class="dropdown">
                            <input type="submit" target="_blank" class="btn btn-light action-button" value="Registrar venta">
                        </li>
                    </form>
                    <form action="producto.jsp" method="POST">
                        <li class="dropdown">
                            <input type="submit" target="_blank" class="btn btn-light action-button" value="Contratos">
                        </li>
                    </form>
                ...
                </form></span><a class="btn btn-light action-button" role="button" href="Principal.jsp">Salir</a>
            </nav>
        </div>
