<%-- 
    Document   : impuesto
    Created on : 17/06/2021, 04:57:41 PM
    Author     : Alvaro
--%>
...
<html>
    <head>
        ...
        <title>Registro de Impuestos</title>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <span class="help-block">Ingrese nombre delimpuesto</span>  
                    </div>
                </div>
                
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Cifra</label>  
                    <div class="col-md-4">
                        <input id="textinput" name="textinputclave" type="text"  class="form-control input-md">
                        <span class="help-block">Ingrese cifra del impuesto</span>  
                    </div>
                </div>
