<%-- 
    Document   : ciudad.jsp
    Created on : 07/06/2021, 02:49:51 PM
    Author     : Alvaro
--%>
                ...
                <div class="container">
                    ...
                    <form action="ciudad" method="POST">
                        <div class="card-details">
                            <h3 class="title">Detalles de la Ciudad</h3>
                            <div class="row">
                                ...
                                <div class="form-group col-sm-7">
                                    ...
                                    <input id="card-holder" type="text" name="descriptxt" class="form-control" placeholder="Ej: Asunción" aria-label="Card Holder" aria-describedby="basic-addon1">
                                </div>
                                <%--BUSCADOR DEL DEPARTAMENTO--%>
                                <div class="form-group col-sm-7">
                                    <label for="card-holder">Departamento</label>
                                    <select id="drop_dep" name="drop_dep" class="form-control">
                                        <%
                                            Departamento depar = new Departamento();
                                            HashMap<String, String> drop = depar.seleccionarDepartamento();
