<%-- 
    Document   : todos
    Created on : 11/08/2020, 06:59:19 PM
    Author     : Alvaro
--%>
...
<html>
    <head>
        ...
        <title>Todos los prestamos pendientes</title>
    ...
    <body>
        ...
        <h2>Resultado de la consulta, prestamos pendientes: </h2>
                        ...
                        <td class="text-center">
                            <form action="muestraPrestamo" method="POST">
                                ...
                                <div class="container-fluid margin">
                                    <input type="submit" target="_blank" class="themeBtn3" value="Pagar cuota">
                                </div>
