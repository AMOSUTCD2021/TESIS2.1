<%-- 
    ...
    Created on : 27/07/2020, 03:03:56 PM
    Author     : Alvaro
--%>
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="error-text">
                            <h1 class="error">Ocurrio un error!!</h1>
                            <div class="im-sheep">
                                <div class="top">
                                    <div class="body"></div>
                                    <div class="head">
                            ...
                            <h4>Registro de prestamo no encontrado en la BD! :(</h4>
                            <p>Vuelva a introducir el numero</p>
                            <form action="consultaPrest.jsp" method="POST">
                                <input type="submit" class="btn btn-primary btn-round" value="Regresar">
                            </form>
