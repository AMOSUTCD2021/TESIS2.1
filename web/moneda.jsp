<%-- 
    Document   : moneda.jsp
    Created on : 07/06/2021, 03:51:09 PM
    Author     : Alvaro
--%>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <span class="help-block">Ingrese nombre de moneda</span>  
                    </div>
                </div>
                
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Cotizacion compra</label>  
                    <div class="col-md-4">
                        <input id="textinput" name="textinputclave" type="text"  class="form-control input-md">
                        <span class="help-block">Cotizacion en la compra actual</span>  
                    </div>
                </div>
                
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Cotizacion venta</label>  
                    <div class="col-md-4">
                        <input id="textinput" name="textinputclave" type="text"  class="form-control input-md">
                        <span class="help-block">Cotizacion en la venta actual</span>  
                    </div>
                </div>
