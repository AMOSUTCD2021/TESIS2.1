                    ...
                    <div class="card-body">
                        <form action="Controlador">
                            ...
                            <div class="input-group form-group">
                                ...
                                <input type="password" class="form-control" name="txtconfcontrasena" placeholder="Confirmar Contraseña">
                            </div>                            
                            <div class="form-group">
                                <input type="submit" name="accion" value="Cambiar" class="btn float-right login_btn">
                            </div>
                        </form>
                    </div>                    
                </div>
