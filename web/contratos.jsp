    ...
    <body>
        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Código del contrato</label>  
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="textinput">Validéz</label>  
                    <div class="col-md-4">
                        <input id="textinput" name="textinputcargo" type="text"  class="form-control input-md">
                        <span class="help-block">Validéz del contrato en meses</span>  
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <span class="help-block">Fecha de finalización del contrato</span>  
                    </div>
                </div>
